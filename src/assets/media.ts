...
export const chapterFrames = [
  unsplash('1541099649-83e6ea6e3de5', 1800),
  unsplash('1551028719-00167b16eac5', 1800),
  unsplash('1558618666-fcd25c85f82e', 1800),
  unsplash('1558171813-4c088753af8f', 1800),
  unsplash('1596755099408-7921c7fb1b5e', 1800),
] as const;
